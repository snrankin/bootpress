...
?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="content-wrapper">
                                    ...
                                    <div class="p-2 mb-2 bg-light text-gray">.bg-light</div>
                                    <div class="p-2 mb-2 bg text-white">.bg</div>
                                    <div class="p-2 mb-2 bg-white text-gray">.bg-white</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-wrapper">
            <div class="container-wrapper-inner">
                <div class="container example-container" data-category="grid">
                    <h1>Grid</h1>
                    <div>
        ...
        <div class="container-fluid example-container" data-category="buttons">
            ...
            <div class="mt-3 mb-5">
                ...
                <p><a href="javascript:void(0);" class="btn btn-primary btn-lg disabled" role="button">The 'a'
                        Element</a></p>
                <p><button type="button" class="btn btn-lg btn-primary" disabled="disabled">The
                        'button'Element</button></p>
                ...
                <div class="col-3">
                    <div class="card card-body">
                        ...
                        <p class="card-text">Boot polish is a waxy paste, cream, or liquid used to polish, shine,
                            and waterproof leather shoes or boots to extend the footwear's life, and restore,
                            maintain and improve their appearance.</p>
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Best ugg boots on the planet. Free shipping, 24/7 customer service.
                            </p>
                        </div>
        ...
        <div class="container-fluid example-container" data-category="tooltip">
            ...
            <div class="mt-3 mb-5">
                <p style="margin:40px;">Check out my <a target="_blank" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Build advanced layouts easily with CSS!">Grid tutorial</a>, as you never
                    know when you might need it!</p>
            </div>
            <h3>All position tooltip</h3>
            <div class="mt-3 mb-5">
                <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="" style="margin:20px;" data-original-title="Top shoes">Shoes</button>
                <button type="button" class="btn btn-info" data-toggle="tooltip" data-placement="right" title="" style="margin:20px;" data-original-title="Right boot">Boots</button>
                <button type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="bottom" title="" style="margin:20px;" data-original-title="Bottom uggs">Ugg</button>
                <button type="button" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="" style="margin:20px;" data-original-title="Left sock">Socks</button>
            </div>
        </div>
        ...
        <div class="container-fluid example-container" data-category="badges">
            ...
            <div class="mt-3 mb-5">
                ...
                <a href="javascript:void(0);" class="badge badge">Dark</a>
            </div>
        </div>
        ...
        <div class="container-fluid example-container" data-category="alerts">
            ...
            <div class="mt-3 mb-5">
                ...
                <div class="alert alert" role="alert">Dark alert</div>
            </div>
        ...
        <div class="container-fluid example-container" data-category="progress-bars">
            ...
            <div class="mt-3 mb-5">
                ...
                <br>
                <div class="progress">
                    <div class="progress-bar bg" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
            ...
            <div class="mt-3 mb-5">
                ...
                <br>
                <div class="progress">
                    <div class="progress-bar progress-bar-striped bg" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
        ...
        <div class="container-fluid example-container" data-category="list-group">
            ...
            <div class="mt-3 mb-5">
                ...
                <div class="list-group">
                    ...
                    <button type="button" class="list-group-item list-group-item-action">Die With Your Boots
                        On</button>
            ...
            <div class="mt-3 mb-5">
                ...
                <div class="list-group">
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action list-group-item-success">These Boots Are Made
                        For Walking</a>
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action list-group-item-success active">Eleanor, Put
                        Your Boots On</a>
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action list-group-item-info">Puss 'n' Boots</a>
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action list-group-item-warning">Die With Your Boots
                        On</a>
                    ...
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action list-group-item">Boot Scootin' Boogie</a>
                </div>
            </div>
        </div>
